...
3. **User/Martín action:** from Martín's WhatsApp (`5215660739660`), send `join <code>` to the
...
5. **This agent's part:** wire the digest agent's final step to a real `POST
   ...
   `whatsapp:+5215660739660`. Genuine API call, genuine delivery — "mock" only in the sense
